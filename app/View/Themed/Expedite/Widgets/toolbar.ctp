		...
		<div class="breadcrumb">
			...
			<ul class="expedite-menu master_menu">
				<?php foreach($_plugins as $plugin): ?>
					<li><?php echo $this->Html->link($plugin . $this->Html->tag('span', '', array('class' => 'ui-icon ui-icon-folder-open')), array('plugin' => strtolower($plugin), 'controller' => Inflector::tableize($plugin)), array('escape' => false)); ?></li>
				<?php endforeach; ?>
				<li>&nbsp;</li>
